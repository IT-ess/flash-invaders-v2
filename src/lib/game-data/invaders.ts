...
export const INVADERS_STARTING_INDEX = PUBLIC_IS_TUTORIAL_DISABLED === "true"
  ? 1
  : 0;
...
let INVADERS: Invader[] = [
  ...
  },
  {
    ...
    carouselCaptions: [
      "Clochers réunis",
      "Vue face église Zwief",
      "Vue intérieure église Zwief",
    ],
    carouselUrls: [
      "/context/2-1.jpg",
      "/context/2-2.jpeg",
  ...
  },
  {
    ...
    carouselCaptions: [
      "Musique",
      "Soirée thème gaulois",
      "Soirée d'adieu à l'ancienne",
    ],
    carouselUrls: [
      "/context/10-1.jpg",
      "/context/10-2.jpg",
    ...
    itemsTypes: ["text", "video", "video"],
    itemsSources: [
      "context.zwt10.content",
      "/jeusoiree.mp4",
      "/plagechant.mp4",
    ],
    itemsCaptions: [
      "",
      "Jeu soirée d'adieu 2022",
      "Soirée aux Sables D'Olonne",
    ],
  },
  {
    id: 11,
